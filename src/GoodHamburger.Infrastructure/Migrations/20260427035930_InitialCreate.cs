    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "MenuItems",
                columns: new[] { "Id", "IsAvailable", "Name", "Price", "Type" },
                values: new object[,]
                {
                    { 1, true, "X Burger", 5.00m, 0 },
                    { 2, true, "X Egg", 4.50m, 0 },
                    { 3, true, "X Bacon", 7.00m, 0 },
                    { 4, true, "Batata frita", 2.00m, 1 },
                    { 5, true, "Refrigerante", 2.50m, 2 }
                });
